    ...
    <Form>
      <Grid container>
        ...
        <Grid item xs={2} align="right">
          <Controls.Button variant="text+icon" text="Agregar Nuevo Pedido" onClick={()=>{history.push('/client/registrarPedido')}}/>
        </Grid>
      </Grid>
      <BoxTbl>
        {pedidosCargados ? (
